	...
	<section id="text">
		...
		<article id="text--paragraphs">
			...
			<div>
				<p>
					...
					rhoncus erat vulputate. Proin ornare massa eget bibendum faucibus.
				</p>
			</div>
		</article>
		...
		<article id="text--inline">
			...
			<div>
				...
				rendered, non-textual annotation.<br />
				...
				/>
				The time element:
				<time datetime="2013-04-06T12:32+00:00">2 weeks ago</time><br />
			</div>
		</article>
	</section>
